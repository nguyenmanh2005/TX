    ...
    <div class="account-center">
                ...
                <div class="user-info">
                    ...
                    <div class="user-stats">
                        <div class="stat-item">
                            ...
                            <div class="stat-value"><?= number_format($user['Money'], 0, ',', '.') ?> VNĐ</div>
                        </div>
                        <div class="stat-item">
        ...
        <div class="menu-grid">
            ...
            <a href="quests.php" class="menu-card">
                ...
                <div class="menu-description">Hoàn thành nhiệm vụ để nhận phần thưởng (<?= $questsCompleted ?> đã hoàn thành)</div>
            </a>
            ...
            <a href="gift.php" class="menu-card">
                ...
                <div class="menu-description">Tặng tiền hoặc items cho bạn bè</div>
            </a>
