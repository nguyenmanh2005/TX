...
<body>
    <div style="text-align: center; padding: 20px;">
        <a href="index.php" style="color: var(--primary-color); text-decoration: none; font-size: 18px;">← Về Trang
            Chủ</a>
    </div>
                ...
                <form id="createChallengeForm">
                    <div class="form-group">
                        ...
                        <div id="selectedOpponent" style="margin-top: 10px; display: none;">
                            <div
                                style="display: flex; align-items: center; gap: 10px; padding: 10px; background: rgba(102, 126, 234, 0.2); border-radius: 8px;">
                                <img id="selectedOpponentAvatar" width="40" height="40" style="border-radius: 50%;">
                                <span id="selectedOpponentName"></span>
                                <button type="button" onclick="clearOpponent()"
                                    style="margin-left: auto; background: #e74c3c; border: none; color: white; padding: 5px 10px; border-radius: 5px; cursor: pointer;">X</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="betAmount" name="bet_amount" min="1000" step="1000" value="10000"
                            required>
                        <small style="color: rgba(255, 255, 255, 0.6);">Số Gtlm hiện tại:
                            <?= number_format($user['Money'], 0, ',', '.') ?> gtlm</small>
                    </div>
        ...
        function createChallengeCard(challenge, showPlay = false) {
            ...
            card.innerHTML = `
                ...
                <div class="challenge-info">
                    ...
                    <div class="challenge-bet">Cược: ${formatMoney(challenge.bet_amount)} gtlm</div>
