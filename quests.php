...
<body>
    ...
    <div class="quests-container">
        <div class="header-quests">
            ...
            <div
                style="margin-top: 10px; font-size: 14px; color: var(--warning-color); font-weight: 600; background: rgba(255, 193, 7, 0.1); padding: 10px; border-radius: var(--border-radius); border: 2px solid var(--warning-color);">
                ⚠️ Lưu ý: Web không hỗ trợ nạp/rút gtlm thật. Tất cả gtlm trong web đều là ảo, chỉ dùng để chơi game
                giải trí.
            </div>
            <?php if (!$questsTableExists): ?>
                <div
                    ...
                    ⚠️ Hệ thống nhiệm vụ chưa được kích hoạt. Vui lòng chạy file <strong>create_quests_tables.sql</strong>
                    trong database.
                </div>
            <?php endif; ?>
        </div>
            ...
            quests.forEach(quest => {
                ...
                card.innerHTML = `
                    ...
                    <div class="quest-reward">
                        💰 Phần thưởng: ${number_format(quest.reward_money, 0, ',', '.')} gtlm
                    </div>
