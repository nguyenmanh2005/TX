...
<body>
    <div class="events-container">
        <div class="header-events">
            ...
            <p style="color: #666; font-size: 18px; margin-top: 10px;">Tham gia các sự kiện đặc biệt để nhận phần thưởng
                độc quyền!</p>
        </div>
        ...
        <?php if (!$eventsTableExists): ?>
            <div class="card">
                <div class="message error">
                    ⚠️ Hệ thống Events chưa được kích hoạt! Vui lòng chạy file <strong>ALL_DATABASE_TABLES.sql</strong>
                    trước.
                </div>
            </div>
        <?php else: ?>
