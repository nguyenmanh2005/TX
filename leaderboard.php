...
<body>
        ...
        <?php else: ?>
            <div class="card">
                ...
                <div id="user-rank-info"
                    style="margin-bottom: 20px; padding: 15px; background: rgba(102, 126, 234, 0.1); border-radius: 12px; display: none;">
    ...
    <script>
        ...
        function displayLeaderboard(leaderboard, type) {
            ...
            if (type === 'overall') {
                html += '<th style="text-align: right;">Tổng gtlm</th>';
            ...
            leaderboard.forEach((player, index) => {
                ...
                if (type === 'overall') {
                    html += '<td style="text-align: right;"><span class="score-value">' + number_format(player.Money) + '</span> gtlm</td>';
                    ...
                    html += '<td style="text-align: right;"><span class="score-value">' + number_format(player.total_earned || 0) + '</span> gtlm</td>';
                    ...
                    html += '<td style="text-align: right;"><span class="score-value">' + number_format(earned || 0) + '</span> gtlm</td>';
                    html += '<td style="text-align: right;">' + (player.games_played || 0) + '</td>';
                }
