    ...
    <div class="container">
                            ...
                            <div class="notification-reward">
                                <?php if ($notif['reward_money'] > 0): ?>
                                    <div class="reward-item">
                                        ...
                                        <span>+<?= number_format($notif['reward_money']) ?> gtlm</span>
                                    </div>
                                <?php endif; ?>
        ...
        <div style="text-align: center; margin-top: 30px;">
            ...
            <a href="achievements.php"
                style="display: inline-block; padding: 12px 24px; background: linear-gradient(135deg, #28a745 0%, #20c997 100%); color: white; text-decoration: none; border-radius: 12px; font-weight: 600; margin-left: 15px;">
