...
const CHARACTER_DB = {
  ...
  dao_tac: { tag: 'Kiếm GTLM', name: 'Đạo Tặc', icon: '🦹', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=daotac', passive: '+15% GTLM thưởng cơ bản.', activeDesc: 'Tráo Phụng: x2 GTLM thưởng của tầng này nếu chiến thắng. (CD: 4 tầng)' },
  than_tai: { tag: 'Kiếm GTLM', name: 'Thần Tài', icon: '🤑', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=thantai', passive: 'Nhận x4 GTLM ở các tầng chia hết cho 5.', activeDesc: 'Hào Quang: Nếu thắng tầng này, nhận GTLM thưởng tương đương tầng Boss. (CD: 4 tầng)' },
  thuong_nhan: { tag: 'Kiếm GTLM', name: 'Thương Nhân', icon: '💰', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=thuongnhan', passive: 'Mỗi tầng tự sinh ra 5% lãi dựa trên tổng thưởng.', activeDesc: 'Hối Lộ: Bỏ qua việc đánh quái (thắng tự động), nhưng bị trừ 20% tổng GTLM tích lũy. (CD: 4 tầng)' },
  tho_san: { tag: 'Kiếm GTLM', name: 'Thợ Săn', icon: '🤠', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=thosan', passive: 'GTLM thưởng từ đánh Boss (Tầng 10, 20...) luôn x2.', activeDesc: 'Đóng Dấu: X10 thưởng nếu thắng, nhưng ATK của quái cũng x2. (CD: 4 tầng)' },
  ...
  cuong_tin: { tag: 'Đột Biến', name: 'Cuồng Tín', icon: '🩸', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=cuongtin', passive: 'HP cực thấp, ATK x2.5.', activeDesc: 'Hy Sinh: Trực tiếp tự sát để tiêu diệt quái, bảo toàn GTLM thưởng và tiến lên tầng mới. (CD: 4 tầng)' },
