...
$botUser = getOrCreateBotStreamerUser($conn, 'bot_1', 50000000);
...
<body>
    ...
    <script>
        ...
        function playGame() {
            ...
            $.post('?action=play', { bets: JSON.stringify(betsData) }, function (res) {
                if (res.success) {
                    setTimeout(() => {
    ...
    // Auto-load history and chart on page load
...
<script src="bots/bot_1.js"></script>
