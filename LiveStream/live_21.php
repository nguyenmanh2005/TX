...
$botUser = getOrCreateBotStreamerUser($conn, 'bot_21', 50000000);
...
<body>
    ...
    <script>
        ...
        function playDice() {
            ...
            $.post('?action=roll', { bet: $('#betAmount').val(), target: currentTarget, mode: currentMode }, function (res) {
                if (res.success) {
...
<script src="bots/bot_21.js"></script>
