...
<body>
    ...
    // Chart.js for ruttham game
    const ctxRuttham = document.getElementById('gameChart');
    if (ctxRuttham) {
        const gameChart = new Chart(ctxRuttham.getContext('2d'), {
            type: 'doughnut',
            data: {
    ...
    window.addEventListener('load', loadRutthamHistory);
