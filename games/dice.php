...
<body>
                ...
                if (res.success) {
                    ...
                    tl.to(marker, {
                        ...
                        onComplete: () => {
                            ...
                            setTimeout(() => { $('#rollBtn').prop('disabled', false).text('🎲 LẮC XÚC XẮC'); isRolling = false; }, 1000);
                        }
                    });
    ...
    <script>
        (function () {
            window.themeConfig = { particleCount: 600, particleSize: 0.05, particleColor: '#f5c842', particleOpacity: 0.5, shapeCount: 12, shapeColors: ["#f5c842", "#f1c40f", "#ffffff"], shapeOpacity: 0.2, bgGradient: ["#000000", "#1a1a1a", "#2c3e50"] };
            const prefix = '../';
