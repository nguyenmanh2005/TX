...
<body>
    ...
    // Chart.js for xocdia game
    const ctxXocdia = document.getElementById('gameChart');
    if (ctxXocdia) {
        const gameChart = new Chart(ctxXocdia.getContext('2d'), {
            type: 'doughnut',
            data: {
    ...
    window.addEventListener('load', loadXocdiaHistory);
    ...
    async function loadXocdiaHistory() {
        try {
            const response = await fetch('xocdia.php?action=get_history', {
                headers: {
