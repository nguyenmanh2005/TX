...
if ($playCount >= 5) {
    ...
    $rewardText = "+ " . number_format($amountWon, 0, ',', '.') . " gtlm";
...
<body>
    ...
    <div class="game-container">
        ...
        <div
            style="background: rgba(40, 167, 69, 0.1); border: 2px solid #28a745; border-radius: var(--border-radius); padding: 15px; margin: 20px 0; font-size: 20px; font-weight: 600; color: #28a745;">
            Số Gtlm hiện tại: <?= number_format($user['Money'], 0, ',', '.') ?> gtlm
        </div>

        <?php if (!empty($error)): ?>
            <div
                style="background: rgba(220, 53, 69, 0.1); border: 2px solid #dc3545; border-radius: var(--border-radius); padding: 15px; margin: 20px 0; color: #dc3545; font-weight: 600;">
        ...
        <div style="margin-top: 30px;">
            <a href="caothe.php"
                style="display: inline-block; margin: 10px; padding: 12px 24px; background: linear-gradient(135deg, var(--secondary-color) 0%, var(--secondary-dark) 100%); color: white; text-decoration: none; border-radius: var(--border-radius); font-weight: 600; transition: all 0.3s ease;">🔁
                Cào tiếp</a>
            <a href="index.php"
                style="display: inline-block; margin: 10px; padding: 12px 24px; background: linear-gradient(135deg, var(--primary-color) 0%, var(--primary-dark) 100%); color: white; text-decoration: none; border-radius: var(--border-radius); font-weight: 600; transition: all 0.3s ease;">🏠
                Trang chủ</a>
        </div>
    </div>
